...
export class RegisterPlayerComponent {
  ...
  registerPlayer(){
    ...
    this.http.get<playerSpecificGameDto>(this.baseUrl + 'timebomb/registernewplayer?gameId='+this.gameId+'&name='+this.playerName)
      ...
      }, error => console.error(error)); // Todo: Exceptionhandling of "TimeBomb.Services.NotAllowedMoveException: Already the maximum of 6 Players joined this game. Therefore no more Players are allowed"
  }
}
